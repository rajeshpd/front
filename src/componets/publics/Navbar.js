...
export default class Navbar extends Component {
  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-default navbar-expand-md fixed-top uppercase navbar-trans">
    ...
    <li className="nav-item dropdown mr-5">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a className="dropdown-item" href="/Login/fundriser">
                   fundriser Login
                  </a>
                  <a className="dropdown-item" href="/Login/donor">
                 donor Login
                  </a>
